...
DRIVER.find_element("xpath",xss_stored_name).send_keys("Test")
DRIVER.find_element("xpath",xss_stored_message).send_keys("<script>alert('This is stored XSS')</script>")

DRIVER.find_element("xpath",xss_stored_submit).click()
ah.clearAllAlerts(DRIVER)
#driver.close()
