...
DRIVER.find_element("xpath",user_path).send_keys("admin")
DRIVER.find_element("xpath",pass_path).send_keys("Password.")
DRIVER.find_element("xpath",submit_path).click()
DRIVER.find_element("xpath",user_path).send_keys("admin")
DRIVER.find_element("xpath",pass_path).send_keys("adminpassword")
DRIVER.find_element("xpath",submit_path).click()
DRIVER.find_element("xpath",user_path).send_keys("admin")
DRIVER.find_element("xpath",pass_path).send_keys("password")
DRIVER.find_element("xpath",submit_path).click()
